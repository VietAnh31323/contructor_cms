...
const CoreInputMoney = (props: Props) => {
  const {
    className,
    control,
    name,
          ...
          <>
            <TextField
              ...
              onChange={(e) => {
                ...
                const parsedValue =
                  type === "number" ? parseMoney(rawValue) : rawValue;
              ...
              value={type === "number" ? formatMoney(value) : value}
              inputRef={ref}
              multiline={multiline}
              minRows={minRows}
              disabled={disabled}
...
export default React.memo(CoreInputMoney);
