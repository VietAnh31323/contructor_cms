...
type Props = {
  ...
  height?: number
  width?: number
  theme?: 'submit' | 'cancel' | 'reset' | 'draft' | 'reject'
} & LoadingButtonProps
...
export const CoreButton = forwardRef<HTMLButtonElement, Props>(
  function ButtonBase(
    ...
    const color = () => {
      ...
      else if (theme === 'reject') return rejectButton.textColor
    }
    ...
    const hoverColor = () => {
      ...
      else if (theme === 'reject') return rejectButton.hoverTextColor
    }
    ...
    const backgroundColor = () => {
      ...
      else if (theme === 'reject') return rejectButton.backgroundColor
    }
    ...
    const backgroundHoverColor = () => {
      ...
      else if (theme === 'reject') return rejectButton.backgroundHoverColor
    }
    ...
    const borderColor = () => {
      ...
      else if (theme === 'reject') return rejectButton.borderColor
    }
    ...
    const borderHoverColor = () => {
      ...
      else if (theme === 'reject') return rejectButton.borderHoverColor
    }
